  ...
  let global_id;
    ...
    if (global_id != '') {
      ...
      $.ajax({
          ...
          data: { "id": global_id,"_token":token }
      })
      .done(function(response) {
          ...
          if(data.status == 1) {
              if (data.address.billing_city != null) {
                address += data.address.billing_city;
              }
              if (data.address.billing_zip_code != null) {
                address += "-" + data.address.billing_zip_code;
              }
              if (data.address.billing_state != null) {
                address += ", " + data.address.billing_state;
              }
