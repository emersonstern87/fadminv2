...
if ($('.main-body .page-wrapper').find('#leadEdit-container').length || $('.main-body .page-wrapper').find('#leadAdd-container').length) {
    $('#contact_date').daterangepicker(dateSingleConfig(), function (start, end) {
        var startDateTime = moment(start, 'MMMM D, YYYY').format(dateFormat);
        $('#contact_date').val(startDateTime);
    });
