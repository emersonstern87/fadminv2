    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.is_default == 1) {
          ...
          $("#edit_status_disallowed_note").html('<div class="py-1 note_padding" id="note_txt_1"> <span class="badge badge-danger">' + jsLang('Note') + '!</span>' + jsLang('Disallowed as default') + '! </div>');
        } else {
          $("#edit_default").prop("checked", false);
          $("#edit_status").attr("readonly", false);
          $("#edit_status_disallowed_note").html('');
        }
        $('#edit_language').modal();
      }
    });
