 ...
 * @return void
 */
function deleteAttachment(url, selector = '.attachment-item-delete') {
	$(document).on('click', selector, function() {
		swal({
		  	title: jsLang('Are you sure?'),
		  	text: jsLang('Are you sure you want to delete this?'),
		  	icon: "warning",
		  	...
		  	if (willDelete) {
		    	...
		    	$.ajax({
		          	...
		          	data: {
			            ...
			            filePath: element.attr('data-attachment'), 
			            _token: token
		          	},
		          	dataType: 'json',
 ...
 * @return void
 */
function uploadAttachment(url, selectorId, selector = ".dropzone-attachments", dataTableUpdate = false) {
	var statusPicture = $("#uploader-text");
  	$(selector).dropzone({
	    ...
	    sending: function(file, xhr, formData) {
	      	formData.append("uploader_id", $(selectorId).val());
