  ...
  {{-- Modal Start--}}
    <div class="modal fade" id="modal-default">
      <div class="modal-dialog">
        <form  method="POST" action="{{ url('update/customer_reply') }}" id="replyModal">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group">
                <textarea  id="txtMessage"  class="txtMessage"  name="message" class="form-control h-200">                    
                </textarea>  
                <label id="txtMessage-error" class="error" for="ticket_messages"></label>
              </div>
            </div>
