...
@section('content')
  <!-- Main content -->
  <div class="col-sm-12" id="supplier-payment-container">
    <div class="card">
      ...
      <div class="col-sm-12">
        <form class="form-horizontal" action="{{ url('supplier/payment/'.$supplierData->id) }}" method="GET" id='orderListFilter'>
      ...
      <div class="card-block">
        <div class="col-sm-12">
          <div class="table-responsive">
            {!! $dataTable->table(['class' => 'table table-striped table-hover dt-responsive supplier-payments', 'width' => '100%', 'cellspacing' => '0']) !!}
          </div>
        </div>
      </div>
    </div>
