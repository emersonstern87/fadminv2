          ...
          <form class="form-horizontal" action="{{url('task/update')}}" method="post" id="task_form">
            ...
            <div class="row">
              <div class="col-sm-10">
                ...
                <div class="form-group row" id="hourly_rate_div display_none">
                ...
                <div class="form-group row" id="showPrevious">
                  ...
                  <div class="col-sm-8">
                    <p><span class="badge badge-secondary f-16 mt-1">{{ $relatedName }}<i class="fa fa-times ml-2 cursor_pointer" title="{{ __('Remove') }}" onclick="javascript: refreshAutoComplete()"></i></span><input type="hidden" name="relatedTo" value="{{ $task->related_to_type }}"><input type="hidden" name="relatedId" value="{{ $task->related_to_id }}"></p>
                  </div>
                </div>
