          ...
          <div class="col-12 col-md-6 col-lg-3 col-xl-3">
            <div class="text-white">
              <div class="p-10 status-border" id="inv-over-due-amount">
                ...
                <span class="f-16">
                  {{ isset($amounts['overDue'][0]->totalDue) ? formatCurrencyAmount($amounts['overDue'][0]->totalDue - $amounts['amounts'][0]->totalPaid, isset($customerData->currency->symbol) && !empty($customerData->currency->symbol) ? $customerData->currency->symbol : '') : formatCurrencyAmount(0, isset($customerData->currency->symbol) && !empty($customerData->currency->symbol) ? $customerData->currency->symbol : '') }}
                </span><br>                   
              </div>
            </div>
          </div>
