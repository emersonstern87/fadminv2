      ...
      <div class="card-block">
        ...
        <div class="row">
          <div class="col-md-9 col-sm-12 m-t-5">
            <p class="cbadge cbadge-default cbadge-outlined f-14 mb-2">{{ __('Department') }}:
           ...
           <?php 
            ...
            ?>
            <p class="cbadge cbadge-default cbadge-outlined f-14 mb-2">{{ __('Priority') }}: 
    ...
    <div class="modal-dialog">
      <form  method="POST" action="{{ url('ticket/save-note') }}" id="noteForm">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              <textarea  id="txtAreaNote" name="message" class="form-control">{{ $note->content ?? '' }}</textarea>
