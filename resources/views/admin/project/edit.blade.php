                ...
                <div class="col-sm-12">
                  ...
                  <div class="form-group row rowMbFireTab-0 rowMb-1rem">
                    ...
                    <div class="col-sm-8">
                      ...
                      <label for="project_type" generated="true" class="error display_inline_block"></label>
                    </div>
                  </div>
                  ...
                  <div class="form-group row rowMb-0 rowMbFireTab-0">
                    ...
                    <div class="col-sm-3">
                      ...
                      <label for="status" generated="true" class="error display_inline_block"></label>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                      <input type="text" id="start_date" name="start_date" class="form-control" value="{{ $project->begin_date }}">
                    </div>
