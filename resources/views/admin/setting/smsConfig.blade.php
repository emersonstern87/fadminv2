                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select class="select form-control" name="default" id="default">
                              ...
                              <option value='Yes' {{ $smsConfig->default == 'Yes' ? 'selected' : "" }} >{{ __('Yes') }} </option>
                              <option value='No' {{ $smsConfig->default == 'No' ? 'selected' : "" }} >{{ __('No') }} </option>
                          </select>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <select class="select form-control" name="status" id="status">
                              <option value="">{{ __('Select One') }}</option>
                              <option value='Active' {{ $smsConfig->status == 'Active' ? 'selected':""}}>{{ __('Active') }}</option>
                              <option value='Inactive' {{ $smsConfig->status== 'Inactive' ? 'selected':""}}>{{ __('Inactive') }}</option>
                            </select>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" value="{{ $smsConfig->key ? $smsConfig->key : '' }}" class="form-control" name="key">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" value="{{ $smsConfig->secretkey ? $smsConfig->secretkey : '' }}" class="form-control" name="secret_key">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" value="{{ $smsConfig->default_number ? $smsConfig->default_number : '' }}" class="form-control" name="number">
                          </div>
                        </div>
