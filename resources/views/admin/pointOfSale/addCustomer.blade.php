    ...
    <div class="tab-content" id="myTabContent">
      ...
      <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group row">
              <div class="col-sm-10"><span id="copy" data-toggle="tooltip" title="{{ __('Copy address from customer information') }}" class="badge badge-pill  theme-bg2 text-white float-right">{{ __('Copy Address') }}</span></div>
            </div>
            <div class="form-group row">
