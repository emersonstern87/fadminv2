                    ...
                    <table class="table table-bordered" id="salesInvoice">
                      <tbody>
                        <tr class="tbl_header_color dynamicRows">
                          ...
                          @endif
                          <th width="10%" class="text-center"> {{ _('Total') }} ({{ isset($purchaseData->currency->symbol) ? $purchaseData->currency->symbol : '' }})
                          </th>
                        </tr>
                        @php
                          $itemsInformation = '';
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-groupa">
              <?php
              $bodyInfo = str_replace('{customer_name}', $purchaseData->supp_name, $emailInfo->body);
