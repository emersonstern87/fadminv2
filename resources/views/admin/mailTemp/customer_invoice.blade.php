              ...
              <div>
                ...
                <div class="row">
                  <div class="col-6 variable">
                    ...
                    <div>
                      <span>{{ __('Purchase Customer Name') }}: <span class="copyButton">{customer_name}</span></span>
                    </div>
                    <div>
                      <span>{{ __('Purchase Invoice Currency') }}: <span class="copyButton">{currency}</span></span>
                    </div>
                    <div>
                  ...
                  <div class="col-6 variable">
                    ...
                    <div>
                      <span>{{ __('Purchase Invoice Summary') }}: <span class="copyButton">{invoice_summery}</span></span>
                    </div>
                  </div>
                </div>
                @elseif($tempId == 7)
                ...
                <div class="row">
                  <div class="col-6 variable">
                    ...
                    <div>
                      <span>{{ __('Company Email') }}: <span class="copyButton">{company_email}</span></span>
                    </div>
                    <div>
                      <span>{{ __('Company City') }}: <span class="copyButton"> {company_city}</span></span>
                    </div>
                    </div>
                  <div class="col-6 variable">
                    <div>
                      <span>{{ __('Company State') }}: <span class="copyButton">{company_state}</span></span>
                    </div>
                    <div>
                      <span>{{ __('Company Street') }}: <span class="copyButton">{company_street}</span></span>
                    </div>
                    <div>
                      <span>{{ __('Company Phone') }}: <span class="copyButton">{company_phone}</span></span>
                    </div>
                  </div>
                </div>
                @elseif($tempId == 18)
                <div class="row">
                  ...
                  <div class="col-6 variable">
                    ...
                    <div>
                      <span>{{ __('Company Web') }}: <span class="copyButton">{company_url}</span></span>
                    </div>
                    <div>
                      <span>{{ __('Company State') }}: <span class="copyButton">{company_state}</span></span>
                    </div>
