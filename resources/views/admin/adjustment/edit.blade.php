                            ...
                            <div class="table-responsive">
                                <table id="transferTbl" class="table table-bordered dt-responsive display nowrap" cellspacing="0">
                                    ...
                                    <tbody id="item-body">
                                        ...
                                        <tr class="addedRow" id="rowid'+e.id+'">
                                            ...
                                            <td class="text-center"><button id="{{ $result->id }}" class="btn btn-xs btn-danger delete_item"><i class="feather icon-trash-2"></i></button></td>
                                        </tr>
