    ...
    public function run()
    {
        ...
        \DB::table('email_templates')->insert(array (
            ...
            array (
                'id' => 4,
                'template_id' => 6,
                'subject' => 'Your purchase # {invoice_reference_no} from {company_name} has been created.',
                'body' => '<html>
                        ...
                        <thead>
                          <tr>
                              <td colspan="2" style="text-align: justify;">
                                <p style="text-align: center;"></p>
                                <p style="font-size: 16px"><strong>Hi {customer_name},</strong></p>
                                <p style="font-size: 16px" style="line-height: 2rem; text-align: justify;">Thank you for your purchase. A brief overview of your purchase is given below,</p>
                                ...
                                <p>Please pay before <strong>{due_date}</strong>. If you have any questions, please feel free to reply to this email.</p>
                                <br />
                            </td>
                          </tr>
                          <tr>
            ...
            array (
                'id' => 17,
                'template_id' => 13,
                'subject' => 'You have assign a project',
                'body' => '<p></p>
            ...
            array (
                'id' => 29,
                'template_id' => 23,
                'subject' => 'Dear valued Supplier welcome to {supplier_name}',
                'body' => '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                        <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml">
                            <head>
                                <meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>
