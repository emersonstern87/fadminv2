   ...
   // dd($data);
    ...
    public function taskEdit($id) 
    {
        ...
        if (!empty($task)) {
            ...
            $project_id = $task->related_to_type == '1' ? $task->related_to_type : 0;
    ...
    public function uploadEventAttachments(Request $request, $save = false)
    {
        ...
        if (!empty($files)) {
            ...
            if (($files->getClientSize() / 1024) > 10240) {
    ...
    public function projectTaskPdf () 
    {
    ...
    public function relatedSearch(Request $request)
    {
        ...
        if (!empty($request->relatedTo)) {
            if ($request->relatedTo == 1) {
                ...
                $result = Customer::where('name', 'LIKE', '%' . $request->search . '%')->get(['id', 'name'])->take(10);
            } else {
