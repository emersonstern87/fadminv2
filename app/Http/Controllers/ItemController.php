...
use App\Model\Item;
use App\Model\ItemCustomVariant;
...
class ItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $data['is_active']    = stripBeforeSave($request->inactive);
    ...
    {
        $data = ['files' => [], 'menu' => 'item', 'header' => 'item', 'breadcrumb' => 'additem'];
    ...
    {
        $data = ['menu' => 'item', 'header' => 'item', 'breadcrumb' => 'addvariant'];
        $data['saleTypes']  = DB::table('sale_types')->get();
