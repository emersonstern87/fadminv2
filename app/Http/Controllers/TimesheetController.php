...
class TimesheetController extends Controller
{
    ...
    public function timesheetListPdf()
    {
        ...
        $data['timerDetails'] = $sheetTimerDetails = $taskTimer->getTaskTime(['from' => $data['from'], 'to' => $data['to'], 'assinee_id' => $data['assignee'], 'project_id' => $data['project'], 'running' => $data['running'] ])->select('task_timers.*', 'users.id as user_id', 'users.full_name', 'tasks.name', 'projects.name')->get();
