...
class LeadController extends Controller
{
        ...
        $this->validate($request, [
         ...
         try {
            DB::beginTransaction();
                ...
                $lead->last_contact   =  DbDateFormat($request->contact_date);
    ...
    public function view($id)
    {
        ...
        foreach ($tagsInResult as $tagIn) {
            $oldTags[] = '<span class="btn btn-outline-secondary custom-btn-small lead-view-tag"><span class="tag-in-result f-11">'. $tagIn->tag->name .'</span></span><br/>';
        }        
        // Eloquent Ends
    ...
    {   
        ...
        try {
            DB::beginTransaction();
                ...
                $leadToUpdate->last_contact   = $request->contact_date;
