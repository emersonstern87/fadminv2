...
class StockTransferController extends Controller
{
    ...
    {
        $data = ['menu' => 'purchase', 'sub_menu' => 'stock_transfer'];
    ...
    {
        return Excel::download(new stockTransferExport(), 'team_member_transfer_list'. time() .'.csv');
    }
    ...
    public function stock_transfer_pdf()
    {
       ...
       $stockTransfer = StockTransfer::with(['sourceLocation:id,name', 'destinationLocation:id,name']);
        ...
        return printPDF($data, 'team_member_transfer_list' . time() . '.pdf', 'admin.stockTransfer.stock_transfer_pdf', view('admin.stockTransfer.stock_transfer_pdf', $data), 'pdf', 'domPdf');
    }
