...
class TicketController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['summary']     = $summary = $this->Ticket->getTicketSummary($from, $to, $allstatus, $allproject, $alldepartment, $allassignee);

        if (!(!empty($from) || !empty($to) || !empty($allproject) || !empty($alldepartment)) ) {
    ...
    public function updateCustomerReply(Request $request)
    {
        $this->validate($request, [
            'message' => 'required',
        ]);
    ...
    public function ticket_pdf()
    {
        ...
        $data['ticketList'] = $this->Ticket->getAllTicketDT($from, $to, $status, $project, $departmentId)->orderBy('last_reply','desc')->get();
