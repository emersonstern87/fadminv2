...
class Project extends Model
{
    ...
    {
        return $this->hasMany("App\Model\ProjectMember", 'project_id');
    }
    ...
    {
        return $this->belongsTo('App\Model\ProjectStatus', 'project_status_id');
    }

    public function saleOrders()
    {
        return $this->hasMany('App\Model\SaleOrder', 'project_id');
    }

    public function tickets()
    {
        return $this->hasMany('App\Model\Ticket', 'project_id');
    }
    //Relation End
