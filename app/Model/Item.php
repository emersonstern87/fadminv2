...
class Item extends Model
{
  ...
  public function stockMoves(){
    return $this->hasMany("App\Model\StockMove", 'item_id');
  }

  public function available()
  {
    return $this->hasOne('App\Model\StockMove')
  ...
  {
    return $this->hasOne('App\Model\File', 'object_id')->where('object_type', 'Item');
  }

  public function variants(){
    return $this->hasMany("App\Model\Item", 'parent_id');
  }

  public function category()
  {
    return $this->belongsTo("App\Model\StockCategory", 'stock_category_id');
  }

  public function parent()
  {
      return $this->belongsTo("App\Model\Item", 'parent_id');
  }
  public function itemCustomVariants()
  {
      return $this->hasMany("App\Model\ItemCustomVariant", 'item_id');
  }

  public function weightUnit()
  {
      return $this->belongsTo("App\Model\ItemUnit", 'weight_unit_id');
  }

  public function salePrices()
  {
      return $this->hasOne("App\Model\SalePrice", 'item_id')->where(['sale_type_id' => 1]);
  }

  public function purchasePrices()
  {
      return $this->hasOne("App\Model\PurchasePrice", 'item_id');
  }
  ...
  public function wholesalePrices(){
      return $this->hasOne("App\Model\SalePrice", 'item_id')->where(['sale_type_id' => 2]);
  }

  public function salesOrderDetails()
  {
      return $this->hasMany("App\Model\SaleOrderDetail", 'item_id');
  }

  public function taxType()
  {
      return $this->belongsTo("App\Model\TaxType", 'tax_type_id');
  }
  ...
  {
      return $this->hasMany('App\Model\PurchaseOrderDetail', 'item_id');
  }
