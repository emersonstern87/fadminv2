...
class Account extends Model
{
    ...
    {
        return $this->hasMany("App\Model\Deposit", 'account_id');
    }

    public function transactions()
    {
        return $this->hasMany("App\Model\Transaction", 'account_id');
    }

    public function fromBankTransfers()
    {
        return $this->hasMany("App\Model\BankTransfer", 'from_account_id');
    }

    public function toBankTransfers()
    {
        return $this->hasMany("App\Model\BankTransfer", 'to_account_id');
    }
    
    public function accountType()
    {
        return $this->belongsTo("App\Model\AccountType", 'account_type_id');
    }
