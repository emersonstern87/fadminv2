...
class SaleOrder extends Model
{
    ...
    {
    	return $this->hasMany('App\Model\SaleOrderDetail', 'sale_order_id');
    }
    ...
    {
        return $this->belongsTo('App\Model\CustomerBranch', 'customer_branch_id');
    }
    ...
    {
        return $this->hasMany('App\Model\StockMove', 'transaction_type_id');
    }

    public function parent()
    {
        return $this->belongsTo('App\Model\SaleOrder', 'id', 'order_reference_id');
    }
