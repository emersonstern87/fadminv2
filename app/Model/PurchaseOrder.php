...
class PurchaseOrder extends Model
{
    ...
    {
        return $this->belongsTo('App\Model\PurchaseReceiveType', 'purchase_receive_type_id');
    }
    ...
    {
        return $this->belongsTo('App\Model\PaymentTerm', 'payment_term_id');
    }

    public function purchaseOrderDetails()
    {
        return $this->hasMany('App\Model\PurchaseOrderDetail', 'purchase_order_id');
    }

    public function receivedOrders()
    {
        return $this->hasMany('App\Model\ReceivedOrder', 'purchase_order_id');
    }

    public function receivedOrderDetails()
    {
        return $this->hasMany('App\Model\ReceivedOrderDetail', 'purchase_order_id');
    }

    public function supplierTransactions()
    {
        return $this->hasMany('App\Model\SupplierTransaction', 'purchase_order_id');
    }
