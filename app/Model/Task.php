...
class Task extends Model
{
    ...
    {
        return $this->belongsTo('App\Model\ProjectStatus','status');
    }
    ...
    {
        return $this->belongsTo('App\Model\TaskStatus','task_status_id');
    } 

    public function taskAssigns()
    {
        return $this->hasMany('App\Model\TaskAssign', 'task_id');
    }
    //Relation Ends
