...
class Expense extends Model
{
    ...
    {
       return $this->belongsTo("App\Model\TransactionReference",'transaction_reference_id');
    }

    public function incomeExpenseCategory() 
    {
      return $this->belongsTo("App\Model\IncomeExpenseCategory", 'income_expense_category_id');
    }
