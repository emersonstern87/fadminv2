    ...
    public function ajax()
    {
        ...
        ->addColumn('order_date', function ($purchaseReport) {
            ...
            if ($searchType == 'daily' || $searchType == 'custom') {
                return '<a href="' . url('report/purchase-report-datewise/' . strtotime($purchaseReport['orderDate'])) . '?' . 'currency=' . $purchaseReport['filterCurrency'] . '&location=' . $location . '&supplier=' . $supplier . '&product=' . $product . ' ">' . formatDate($purchaseReport['orderDate']) . ' </a>';
                ...
                return '<a href="' . url('report/purchase_report_filterwise/') . '?' . 'currency=' . $purchaseReport['filterCurrency'] . '&location=' . $location . '&supplier=' . $supplier . '&product=' . $product . '&month=' . date('m',strtotime($purchaseReport['orderDate'])) . '&year=' . date('Y',strtotime($purchaseReport['orderDate'])) . ' ">' . date('F-Y',strtotime($purchaseReport['orderDate'])) . ' </a>';
            } else {
                return '<a href="' . url('report/purchase-report-datewise/' . strtotime($purchaseReport['orderDate'])) . '?' . 'currency=' . $purchaseReport['filterCurrency'] . '&location=' . $location . '&supplier=' . $supplier . '&product=' . $product . ' ">' . formatDate($purchaseReport['orderDate']) . ' </a>';
            }
        })
