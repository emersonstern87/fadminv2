    ...
    public function ajax()
    {
        ...
        return datatables()
            ...
            ->addColumn('project_name', function ($projects) {
                ...
                $fullProjectColumn = "<a href='" . url( "project/details/" . $projects->project_id) . "'>$projectName</a><br/><span class='f-12 customer-task'>" . str_replace('_', ' ', ucwords($projects->project_type, '_')) . "</span>";
            ...
            ->addColumn('customer_name', function ($projects) {
                ...
                $customer = "<a href='" . url("customer/edit/" . $projects->customer_id) . "'>" . $customerName. "</a>";
                return $customer;
            })
