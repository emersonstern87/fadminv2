        ...
        return datatables()
            ->of($tasks)->addColumn('action', function ($tasks) {
               ...
               $edit=$delete='';
                ...
                $top = '<div class="btn-group"><button type="button" style="color:'. (($tasks->priority_name == 'High') ? '#099909' : '#367fa9') .';"  class="badge f-12 dropdown-toggle task-priority" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
