...
Route::group(['middleware' => ['customer', 'locale']], function() {
    ...
    Route::post('update/customer_reply', 'TicketController@updateCustomerReply');
...
Route::group(['middleware' => ['auth', 'locale'] ], function() {
    ...
    Route::post('ticket/priority-status', 'TicketController@changePriority');
...
Route::get('status/{id}','PaymentGatewayController@getPaymentStatus');
